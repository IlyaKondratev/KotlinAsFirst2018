...
class Tests {
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("", dateDigitToStr("A.02.1993"))
    }
    ...
    fun bestHighJump() {
        ...
        assertEquals(-1, bestHighJump("220 + 224 %+ 228 %- 230 + 232 A%- 234 %"))
        assertEquals(-1, bestHighJump("22A +"))
        assertEquals(-1, bestHighJump("226 + % 222"))
    }
